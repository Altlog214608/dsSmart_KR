...
id_test_data = [
    ...
    {'choice1': '마늘','choice2': '초콜릿','choice3': '오이','choice4': '레몬','answer': '초콜릿','scent_no': 2,'outlet_no': 1,
     'choice5':'사과','choice6':'비누','choice7':'계란','choice8':'버섯','choice9':'홍삼','choice10':'복숭아'},
    ...
    {'choice1': '빵','choice2': '겨자','choice3': '오징어','choice4': '멜론','answer': '멜론','scent_no': 4,'outlet_no': 1,
    ...
    {'choice1': '재/연기','choice2': '옥수수','choice3': '바나나','choice4': '잔디','answer': '재/연기','scent_no': 10,'outlet_no': 1,
    ...
    {'choice1': '청포도','choice2': '비누','choice3': '국수','choice4': '고무','answer': '비누','scent_no': 12,'outlet_no': 1,
     'choice5':'사과','choice6':'쇠','choice7':'홍삼','choice8':'레몬','choice9':'장미','choice10':'땅콩'}
]
